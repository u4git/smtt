...
import org.apache.spark.smtt.SMTT
...
private[spark] class MemoryStore(
  ...
  def putBytes[T: ClassTag](
    ...
    if (memoryManager.acquireStorageMemory(blockId, size, memoryMode)) {
      ...
      /*
       * SMTT. Trace storage serialized memory.
       */
      SMTT.traceStorageSeri(SMTT.ACCESSTYPE_WRITE, blockId.toString, entry.buffer.chunks)
  ...
  private[storage] def putIteratorAsValues[T](
    ...
    if (keepUnrolling) {
      ...
      if (enoughStorageMemory) {
        ...
        /*
         * SMTT. Trace storage deserialized memory.
         */
        SMTT.traceStorageDese(SMTT.ACCESSTYPE_WRITE, blockId.toString, entry.value)
  ...
  def getBytes(blockId: BlockId): Option[ChunkedByteBuffer] = {
    ...
    entry match {
      ...
      case SerializedMemoryEntry(bytes, _, _) =>
         ...
         * SMTT. Trace storage serialized memory.
         */
        SMTT.traceStorageSeri(SMTT.ACCESSTYPE_READ, blockId.toString, entry.asInstanceOf[SerializedMemoryEntry[_]].buffer.chunks)
  ...
  def getValues(blockId: BlockId): Option[Iterator[_]] = {
    ...
    entry match {
      ...
      case DeserializedMemoryEntry(values, _, _) =>
         ...
         * SMTT. Trace storage deserialized memory.
         */
        SMTT.traceStorageDese(SMTT.ACCESSTYPE_READ, blockId.toString, entry.asInstanceOf[DeserializedMemoryEntry[_]].value)
