...
final class ShuffleInMemorySorter {
  ...
  public void insertRecord(long recordPointer, int partitionId) {
    ...
    /*
     * SMTT. Register array-->inMemSorter.
     */
    SMTT.registerArray2InMemSorter(array.hashCode(), this.hashCode());

    array.set(pos, PackedRecordPointer.packPointer(recordPointer, partitionId));

    /*
     * SMTT. Remove array-->inMemSorter.
     */
    SMTT.removeArray2InMemSorter(array.hashCode());
    pos++;
  }
