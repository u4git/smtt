...
final class ShuffleExternalSorter extends MemoryConsumer {
  ...
  public void insertRecord(Object recordBase, long recordOffset, int length, int partitionId)
    ...
    /*
     * SMTT. Trace execution intermediate results.
     */
    SMTT.traceExecutionData(SMTT.ACCESSTYPE_WRITE(), this.hashCode(), base, pageCursor, length);

    /*
     * SMTT. Register inMemSorter-->sorter.
     */
    SMTT.registerInMemSorter2Sorter(inMemSorter.hashCode(), this.hashCode());

    inMemSorter.insertRecord(recordAddress, partitionId);

    /*
     * SMTT. Remove inMemSorter-->sorter.
     */
    SMTT.removeInMemSorter2Sorter(inMemSorter.hashCode());
  }
