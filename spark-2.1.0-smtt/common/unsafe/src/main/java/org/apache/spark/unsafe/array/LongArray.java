...
public final class LongArray {
  ...
  public void set(int index, long value) {
    ...
    /*
     * SMTT. Trace execution pointers of intermediate results.
     */
    SMTT.traceExecutionPointer(SMTT.ACCESSTYPE_WRITE(), this.hashCode(), baseObj, baseOffset + index * WIDTH, WIDTH);
  }
